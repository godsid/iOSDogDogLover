...
@interface mainView_ipad : GAITrackedViewController<UITableViewDataSource,UITableViewDelegate,UIActionSheetDelegate,MFMailComposeViewControllerDelegate,MFMessageComposeViewControllerDelegate,EGORefreshTableHeaderDelegate,GADBannerViewDelegate,GADInterstitialDelegate>
{
    NSString *urlMain;
