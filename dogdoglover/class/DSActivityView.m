...
- (void)layoutSubviews;
{
    ...
    NSDictionary *dictionary = @{ NSFontAttributeName:[UIFont systemFontOfSize:[UIFont systemFontSize]]};
    CGSize textSize = [self.activityLabel.text sizeWithAttributes:dictionary];
...
- (void)layoutSubviews;
{
    ...
    self.frame = [self enclosingFrame];
        ...
        NSDictionary *dictionary = @{ NSFontAttributeName:[UIFont boldSystemFontOfSize:[UIFont systemFontSize]]};
        CGSize textSize = [self.activityLabel.text sizeWithAttributes:dictionary];
